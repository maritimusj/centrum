...
-- 表：api_resources
CREATE TABLE "api_resources" ("id"  INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name"  TEXT(64) NOT NULL, "title"  TEXT(128) NOT NULL,"desc"  TEXT(255) NOT NULL);
...
-- 表：states
CREATE TABLE states (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, enable INTEGER NOT NULL DEFAULT 0, title TEXT (64) NOT NULL, "desc" TEXT (512) NOT NULL, equipment_id INTEGER NOT NULL DEFAULT 0, measure_id INTEGER NOT NULL DEFAULT 0, extra BLOB NOT NULL, created_at DATETIME NOT NULL);
